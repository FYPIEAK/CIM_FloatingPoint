...
HD_PWD='D:/E/STUDY/explore/ReDCIM/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReDCIM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReDCIM.tcl
